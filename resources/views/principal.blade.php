...
<head>
    ...
    <title>CRUD 1.0.0</title>
    <link rel="canonical" href="https://getbootstrap.com/docs/5.3/examples/navbars/">
    <script src="https://getbootstrap.com/docs/5.3/assets/js/color-modes.js"></script>
    <link href="https://getbootstrap.com/docs/5.3/dist/css/bootstrap.min.css" rel="stylesheet">

    <meta name="theme-color" content="#712cf9">
    <link href="https://getbootstrap.com/docs/5.3/examples/navbars/navbars.css" rel="stylesheet">
...
<body> 
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle"> <button
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-light shadow p-1 mb-5 bg-body-tertiary rounded"
            aria-label="Eighth navbar example">
            <div class="container text-dark"> <a class="navbar-brand text-dark" href="#">CRUD</a> <button
                    class="btn-sm navbar-toggler bg-dark" type="button" data-bs-toggle="collapse"
                    data-bs-target="#navbarsExample07" aria-controls="navbarsExample07" aria-expanded="false"
                    aria-label="Toggle navigation"> <span class="navbar-toggler-icon fs-6"></span> </button>
                <div class="collapse navbar-collapse " id="navbarsExample07">
                    <ul class="navbar-nav me-auto text-dark  mb-2 mb-lg-0">
                        <li class="nav-item text-dark"> <a class="nav-link active text-dark" aria-current="page" href="{{ route('lista_contato.create') }}">Novo</a> </li>
                        <li class="nav-item text-dark"> <a class="nav-link text-dark" href="{{ route('lista_contato.index') }}">Lista contatos</a> </li>
